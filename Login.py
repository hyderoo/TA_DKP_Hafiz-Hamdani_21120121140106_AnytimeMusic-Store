...
email_img = PhotoImage(file = f"img_textBoxemail.png")
...
password_img = PhotoImage(file = f"img_textBoxpass.png")
...
imgbutton = PhotoImage(file = f"imglogin.png")
...
background_img = PhotoImage(file = f"oasis.png")
