...
gitar_img = PhotoImage(file = f"img_textBox0.png")
...
piano_img = PhotoImage(file = f"img_textBox1.png")
...
viola_img = PhotoImage(file = f"img_textBox2.png")
...
saxophone_img = PhotoImage(file = f"img_textBox3.png")
...
drum_img = PhotoImage(file = f"img_textBox4.png")
...
keyboard_img = PhotoImage(file = f"img_textBox5.png")
...
bass_img = PhotoImage(file = f"img_textBox6.png")
...
harp_img = PhotoImage(file = f"img_textBox7.png")
...
lbl_no_bill_img = PhotoImage(file = f"img_textBox8.png")
...
lbl_date_img = PhotoImage(file = f"img_textBox9.png")
...
lbl_total_img = PhotoImage(file = f"img_textBox10.png")
...
button_total = PhotoImage(file = f"img0.png")
...
button_reset = PhotoImage(file = f"img1.png")
...
button_exit = PhotoImage(file = f"img2.png")
